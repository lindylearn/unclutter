...
<div class="relative font-header hover:drop-shadow cursor-pointer lindy-tooltip lindy-fade" data-title={`Created ${totalAnnotationCount} private note${totalAnnotationCount !== 1 ? "s" : ""}`}>
    <svg
        viewBox="0 0 100 100"
