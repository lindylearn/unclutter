...
<a class="feedback-container max-w-full px-2 py-2 pr-3 cursor-pointer relative rounded-lg shadow hover:shadow-md transition-all" href={`https://github.com/lindylearn/unclutter/releases/tag/${version}`} target="_blank" on:click={() => reportEventContentScript("clickUpdateMessage", {version})}>
