...
<div class="feedback-container max-w-full px-2 py-2 pr-3 cursor-pointer relative rounded-lg shadow hover:shadow-md transition-all">   
    <div class="flex items-center justify-between gap-1">
        
        <!-- <div class="text-sm font-bold flex items-center bg-white rounded-lg hover:shadow">
            <svg class="w-7 flex-shrink-0 mr-1 text-gray-900" viewBox="0 0 512 512">           
                <path
                    fill="currentColor"
