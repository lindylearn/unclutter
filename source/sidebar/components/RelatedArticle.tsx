...
export default function RelatedArticle({
    ...
    return (
        ...
        >
            ...
            /> */}
            <svg className="w-3.5 shrink-0 grow-0" viewBox="0 0 640 512">
                <path
                    fill="currentColor"
            ...
            <div>
                <div className="font-header font-bold">{article.title}</div>
                <div className="">{article.word_count / 200} mins</div>
            </div>
        </div>
    );
}
