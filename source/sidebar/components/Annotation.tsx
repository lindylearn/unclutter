...
function Annotation({
    ...
    return (
        <div
            className={
                "annotation py-1 px-2 bg-white rounded drop-shadow-sm text-gray-700 " +
                className
            }
        ...
        >
            ...
            <div className="text-xs text-gray-400 flex gap-5 justify-between">
                ...
                >
                    ...
                    <div className="whitespace-nowrap">{upvoteCount}</div>
                </div>
