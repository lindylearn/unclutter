...
import { getUnclutterVersion, setUnclutterLibraryAuth } from "../../common";
...
export default function AboutModalTab({}: {}) {
    ...
    return (
        <div className="animate-fadein flex flex-col gap-4">
            ...
            {userInfo?.aiEnabled && unclutterVersion && unclutterVersion < "1.7.0" && (
                <SettingsGroup
                ...
                >
                    <p>
                        Some of these features require the newest version of the Unclutter
                        extension. Please manually update Unclutter from {unclutterVersion} to
                        1.7.0.
                    </p>
                </SettingsGroup>
            )}
