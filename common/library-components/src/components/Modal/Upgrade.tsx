    ...
    return (
        <div className="flex min-h-full flex-col gap-4">
            ...
            <div className="mt-4 flex gap-4">
                <a
                    className="flex cursor-pointer items-center gap-2 rounded-md bg-stone-100 px-3 py-2 font-medium transition-transform hover:scale-[98%] dark:bg-neutral-800"
