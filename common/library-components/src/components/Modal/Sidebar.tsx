        ...
        },
        {
            ...
            svg: (
                <svg className="h-4" viewBox="0 0 512 512">
                    <path
                        fill="currentColor"
                        d="M416 80h-96v-32C320 39.2 327.2 32 336 32h64C408.8 32 416 39.2 416 48V80zM192 48C192 39.2 184.8 32 176 32h-64C103.2 32 96 39.2 96 48v32h96V48zM512 432c.2253 26.44-21.15 48-47.59 48H336c-26.51 0-48-21.49-48-48V288H224v144C224 458.5 202.5 480 176 480H47.59C21.15 480-.2254 458.4 0 432l.375-44c3.374-129.7 60.96-150.1 63.5-243.9c.4767-17.61 14.38-32.1 32-32.1L191.1 112C209.7 112 224 126.3 224 144V160h64V144c0-17.67 14.33-32 32-32l96.12 .0001c17.62 0 31.53 14.49 32 32.1C450.7 237.9 508.3 258.3 511.6 388L512 432zM176 160H111.1C107.4 205 92.75 236.6 79.75 264.8c-15.38 33-29.88 64.25-31.5 124.5L48 432.4L176 432V160zM464 432l-.375-43.63c-1.5-59.38-16-90.63-31.38-123.6C419.3 236.6 404.6 205 400.9 160H336v272H464z"
                    />
                </svg>
            ),
        },
