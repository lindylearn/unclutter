...
export function ProgressCircle({
    ...
    return (
        <div className="font-title relative scale-90 cursor-pointer">
            ...
            <div
                className={
                    "caption absolute flex w-full select-none justify-center text-center font-semibold " +
                    (showCelebration && current >= target ? "goal-reached" : "")
                }
                style={{ top: "20%", left: "0" }}
            >
                <svg
                    className="icon celebration-icon invisible absolute"
                ...
                <span className="count absolute">{`${current || 0}`}</span>
            </div>
        </div>
    );
}
