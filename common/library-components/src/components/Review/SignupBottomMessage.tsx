                ...
                <div className="flex w-full items-start gap-2">
                    <div className="w-full">
                        <div className="font-title mx-auto mb-2 flex w-max items-center gap-2 text-lg font-semibold">
                            ...
                            Remember what you read with the Unclutter Library
                        </div>
                        ...
                        <ul className="mx-auto grid w-max grid-cols-2 items-center gap-y-1 gap-x-4">
                            <BulletPoint
                                ...
                                text="Save highlights with automatic tagging"
                            />
                            <BulletPoint
                                icon={
                                ...
                                text="AI search across everthing you've seen"
                            />
                            <BulletPoint
                                icon={
                                    <svg className="h-4 w-4" viewBox="0 0 512 512">
                                ...
                                text="Connect similar ideas across articles"
                            />
