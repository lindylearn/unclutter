...
function Annotation({ annotation, heightLimitPx }: AnnotationProps) {
    const { excerpt, text, platform, infoType, sentenceScore } = annotation;
    ...
    return (
        <div
            className="annotation relative flex cursor-pointer flex-col overflow-hidden rounded-l rounded-r-md p-1 pl-2 text-sm shadow transition-transform hover:scale-[99%]"
            style={{
                borderLeft: `8px solid rgba(250, 204, 21, ${0.8 * sentenceScore ** 3})`,
        ...
        >
            <div
                className="annotation-text select-none p-1 pb-0"
                style={{
                    display: "-webkit-box",
            ...
            <div className="annotation-bar font-title relative flex select-none items-center gap-2 overflow-hidden whitespace-nowrap p-1">
