...
export default function RelatedArticle({ annotation, className }: RelatedArticleProps) {
    ...
    return (
        ...
        >
            {/* <div
                ...
                className="shadow-[0_1px_3px_0.1px_rgb(0,0,0,20%) -mt-5 -mb-5 h-[100px] w-[83px] shrink-0 rounded bg-cover"
                style={{ backgroundImage: `url(${imageUrl})` }}
            /> */}
            <div>
                <div className="font-title font-bold">
                    <svg className="inline-block w-4 shrink-0 grow-0" viewBox="0 0 640 512">
                        <path
                            fill="currentColor"
                ...
                <div className="">{Math.ceil(article.word_count / 200)} min read</div>
            </div>
        </div>
    );
}
